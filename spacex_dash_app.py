...
# TASK 2: Add callback function for `site-dropdown` as input, `success-pie-chart` as output
...
# TASK 4: Add callback function for `site-dropdown` and `payload-slider` as inputs, `success-payload-scatter-chart` as output
